...
#define MAX_PLAYER_SPEED                                                       \
  5.0f * 60.0f             // Velocidade máxima do jogador (pixels/segundo)
...
#define PLAYER_SPAWN_TIME_NO_COLLISION 3.0f // Tempo sem colisão ao spawnar
...
#define PROBABILITY_SPAWN_TILE_BRICK_ON_MAP                                    \
  30 // Probabilidade (%) de tijolos aparecerem
